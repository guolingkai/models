            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        label = None if hide_labels else (pest24_names[names[c]] if hide_conf else f'{pest24_names[names[c]]} {conf:.2f}')
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5m_best.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default=ROOT / 'img1', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'pest24-data.yaml', help='(optional) dataset.yaml path')
